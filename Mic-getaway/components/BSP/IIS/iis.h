 ...
 *
 * 硬件输出格式：
 *   PCM16 单声道 24 kHz -> I2S PDM TX 硬件 PCM2PDM。
 *
 * 职责边界：
...
/* PCM2PDM 升采样分母；24 kHz 下为 240，对应约 6.144 MHz PDM clock。 */
...
/* speaker 层公开输入采样率：PCM16 mono 24 kHz。 */
...
/* 24 kHz PCM2PDM 期望生成约 6.144 MHz PDM clock，低于 95% 视为配置异常。 */
